...
def Data(agente):
    ...
    print("Pos x --> (estimado):",round(agente.xc[-1]*100), "  - (real): ", round(agente.T_Exploracion_GPS_x[-1]*100-agente.delta_GPS_Estimado_x*100))
    print("Pos y --> (estimado):",round(agente.yc[-1]*100), "  -  (real):", round(agente.T_Exploracion_GPS_y[-1]*100-agente.delta_GPS_Estimado_y*100))
    print("Rotación --> (estimado): ", round(agente.phi,0), " - (real): ",agente.angulo)
